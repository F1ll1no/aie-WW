...
def report(
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- id пользователей уникален: **{quality_flags['has_suspicious_id_duplicates']}**\n\n")
        f.write(f"- есть колонки с постоянным значением: **{quality_flags['has_constant_columns']}**\n\n")
